...
app.layout = html.Div(children=[
    ...
    dcc.RadioItems(options=lista_marcas, value="Todas", id="Selecao_de_marcas", style={'font-size':'20px', 'padding-bottom':'1%'}),

    # Para centralizar o botão de seleção suspenso, será preciso colocá-lo em uma Div.
    html.Div(children=[
        dcc.Dropdown(options=lista_paises, value="Todos", id="Selecao_de_paises")],
        style={"width": '25%', "margin":"auto", 'font-size':'20px'}),
...
@app.callback(
    Output('Selecao_de_paises', 'options'),
    Input('Selecao_de_marcas', 'value'),
)
